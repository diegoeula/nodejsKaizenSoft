...
function convert(external) {
    ...
    if (!_.isEmpty(external)) {
            ...
            _.each(component.types, function (type) {
                switch (type.toLowerCase()) {
                    case TAG_COUNTRY:
                        ...
                        internal.country_code = component.short_name;
                        break;
                    case TAG_ADMIN_A1:
                        ...
                        break;
                    case TAG_ADMIN_A2:
                        internal.state_district = component.long_name;
                        break;
                    case TAG_CITY:
                        internal.city = component.long_name;
                        break;
                    case TAG_SUBCITY:
                        internal.suburb = component.long_name;
                        break;
                    case TAG_SUBCITY_L1:
                        internal.suburb = component.long_name;
                        break;
                    ...
                    case TAG_COLLOQUIAL_AREA:
                        ...
                        break;
                    case TAG_POSTAL:
                        internal.postcode = component.long_name;
                        break;
                    case TAG_ROUTE:
                        internal.road = component.long_name;
                        break;
                    ...
                    case TAG_HOUSE_NUMBER:
                        internal.house_number = component.long_name;
                        break;
                    case TAG_PREMISE:
        ...
        if (external.formatted_address) {
            internal.display_name = external.formatted_address;
        }
        if (external.types) {
            internal.type = external.types[0];
        }
        ...
        if (external.geometry) {
            ...
            if (geometry.location) {
                internal.lat = external.geometry.location.lat;
                internal.lon = external.geometry.location.lng;
            }
